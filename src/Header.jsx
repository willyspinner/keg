...
const Header = (props) => {
  return (
    <div style={{ backgroundColor: '#ffff0fa3', borderBottom: '1px solid #eaeaea', display: 'flex', paddingBottom: '0.5em', flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'flex-start', marginBottom: '0.5rem' }}>
